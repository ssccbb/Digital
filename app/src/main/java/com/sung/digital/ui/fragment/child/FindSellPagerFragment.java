...
public class FindSellPagerFragment extends BaseFragment {
    private static FindSellPagerFragment instance;
    private RecyclerView mList;
    private List mData = new ArrayList();

    public static FindSellPagerFragment newInstance(){
        if (instance != null){
            return instance;
        }
        return new FindSellPagerFragment();
    }

    public FindSellPagerFragment() {
    }
