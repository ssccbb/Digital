...
public class FindNewsPagerFragment extends BaseFragment {
    private static FindNewsPagerFragment instance;
    private RecyclerView mList;
    private List mData = new ArrayList();

    public static FindNewsPagerFragment newInstance(){
        if (instance != null){
            return instance;
        }
        return new FindNewsPagerFragment();
    }

    public FindNewsPagerFragment() {
    }
